...
### DASH APP ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### 
#dash_app21 = Dash(__name__, server = app, url_base_pathname = webtype + '/search_ccc_articles/', external_stylesheets=external_stylesheets ,external_scripts=external_scripts)
dash_app21 = Dash(url_base_pathname = '/time_articles/', external_stylesheets=external_stylesheets, suppress_callback_exceptions = True)

dash_app21.config['suppress_callback_exceptions']=True


dash_app21.title = 'Time Articles'+title_addenda
...
if __name__ == '__main__':
    dash_app21.run_server(debug=True)#,dev_tools_ui=False)
