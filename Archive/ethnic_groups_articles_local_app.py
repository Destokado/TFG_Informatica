...
dash_app20 = Dash(url_base_pathname = '/ethnic_groups_articles/', external_stylesheets=external_stylesheets, suppress_callback_exceptions = True)
...
#        query += 'REPLACE(page_title,"_"," ") as page_title, '
        ...
        columns_dict = {'position':'Nº','page_title':'Title','target_langs':'Target Langs.','qitem':'Qitem', 'primary_lang':'Source Lang.'}
...
if __name__ == '__main__':
    dash_app20.run_server(debug=True) # ,dev_tools_ui=False)
