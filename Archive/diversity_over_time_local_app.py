...
conn = sqlite3.connect(databases_path + 'stats.db'); cursor = conn.cursor() # stats_prova_amb_indexs
...
default_period = periods[2] # THIS SHOULD BE CHANGED TO 0
...
#    navbar,
    ...
    dcc.Markdown('''
        ...
        * What is the extent of the different types of content created and accumulated in the Wikipedia language editions on a specific month?
        * What Wikipedia language editions have created more content of the different types on a specific month?
...
#        subplot_titles = ('Accumulated Articles'+'<br />&nbsp;<br />', 'Created Articles'+'<br />&nbsp;<br />'),
    ...
    if language != None and period != None and content_type != None: 
        ...
        if period != None:
            extra = " On A Specific Month ("+period+")"
...
#            title=created_accumulated,
        ...
        title_text='Comparison of Wikipedias by Content Types Created On A Specific Month'+extra
    )
...
#            title=created_accumulated,
        ...
        title_text='Comparison of Wikipedias by Content Types Accumulated On A Specific Month'+extra
    )
...
def update_monthly_barchart(language, content_type, time_aggregation, absolute_relative):
    ...
    if content_type != '':
        ...
        print('després de periods'+str(datetime.timedelta(seconds=time.time() - functionstartTime)))
...
def set_entities_group_options_given_timeseries(selected_group, compare):
    ...
    print (entities_list, selected_entities)
    print (compare)
