...
title_addenda = ' - Wikipedia Diversity Observatory (WDO) Dev. page'
...
if __name__ == '__main__':
    app_dev.run_server(host='0.0.0.0', port=81, threaded=True, debug=True)


##### DASH APPS #####

print ('* importing apps. dev version.')
print (str(datetime.timedelta(seconds=time.time() - setting_up_time)))

# others
from apps_dev.home_app import *
# from apps_dev.data_status_app import *
...
# from apps_dev.lgbtq_gap_app import *
