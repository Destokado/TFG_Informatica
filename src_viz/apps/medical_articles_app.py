...
### DASH APP ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
app = Dash(__name__, server=app_dev, url_base_pathname=webtype + '/medical_articles/',
...
topic_dict = {'All': 'all', 'Keywords': 'keywords', 'Geolocated': 'geolocated', 'People': 'people', 'Women': 'women',
              ...
              'Not people': 'not_people', 'CCC': 'ccc', 'CCC Not People': 'ccc_not_people','LGBT': 'lgbt_topic'}
...
features_dict = {'Editors': 'num_editors', 'Edits': 'num_edits', 'Pageviews': 'num_pageviews', 'Inlinks': 'num_inlinks',
                 ...
                 'Outlinks to CCC': 'num_outlinks_to_CCC', 'Medicine Topic': 'medicine'}
...
text_default = '''In this page you can retrieve Medical articles from Wikipedia language editions, including biographies and all kinds of topics, and check its availability in a specific Wikipedia.'''
...
interface_row1 = html.Div([
    ...
    html.Div(
        [
            ...
            dbc.Tooltip(
                html.P(
                    "Select the language editions from which you want to retrieve the Medicine articles they have in common. You can retrieve a single language if you want. The relevance features will be according to the first language.",
...
interface_row2 = html.Div([
    ...
    html.Div(
        [
            ...
            dbc.Tooltip(
                html.P(
                    "Select a feature to sort the results (by default the Medicine Topic).",
...
def dash_app19_build_layout(params):
    ...
    if len(params) != 0 and params['target_langs'].lower() != 'none' and params['source_lang'].lower() != 'none':
        ...
        columns = ['num', 'qitem', 'page_title', 'num_editors', 'num_edits', 'num_pageviews', 'num_interwiki',
                   'num_bytes', 'date_created', 'medicine']
        ...
        # print (columns)
        item_labels_dict = dash_apps_dev.get_item_labels(df['Medicine Topic'].drop_duplicates(keep='first'),source_lang)
