...
dash_app6.layout = html.Div([
    ...
    dcc.Markdown('''
        This page shows statistics and graphs that illustrate the distribution of pageviews for the different categories of diversity in each Wikipedia language edition.. 
       '''),
    # dcc.Markdown('''
