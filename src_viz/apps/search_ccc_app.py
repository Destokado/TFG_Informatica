...
text_default = '''In this page you can search for articles in a Wikipedia language edition according to different categories relevant to diversity and also through the use of keywords and see their availability in other language editions.'''
