...
dash_app16.layout = html.Div([
    ...
    dcc.Markdown('''
        This page shows stastistics and graphs that illustrate the Religious Groups gap in Wikipedia language editions content. They depict Religious Groups understood as biographies of people with a religious group affiliation. For more information on the gaps, you can retrieve lists of Religious Groups articles in the [Top CCC Lists Dashboard](https://wdo.wmflabs.org).
