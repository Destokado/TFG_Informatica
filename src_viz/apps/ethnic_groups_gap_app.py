...
dash_app11.layout = html.Div([
    ...
    dcc.Markdown('''
        This page shows stastistics and graphs that illustrate the Ethnic Groups gap in Wikipedia language editions content. They depict both Ethnic Groups understood as biographies of people belonging to an ethnic group and topics that relate to the Ethnic Groups cultural contexts (e.g. places, monuments, traditions, etc.). For more information on the gaps, you can retrieve lists of Ethnic Groups articles in the [Top CCC Lists Dashboard](https://wdo.wmflabs.org).
