...
#        df = pd.read_csv(databases_path + 'lgbt.csv')
        ...
        text_results = '''
        The following table shows the resulting list of articles about LGBT in the source language ''' + source_language + ''', and its availability in the target languages.
