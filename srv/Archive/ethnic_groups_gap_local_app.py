...
# content_type = 'ethnic_group_names_wikipedia_extent'
...
# dash_app11 = Dash(__name__, server = app, url_base_pathname= webtype + '/lgbt+_gap/', external_stylesheets=external_stylesheets, external_scripts=external_scripts)
...
if __name__ == '__main__':
    dash_app11.run_server(debug=True)#,dev_tools_ui=False)
