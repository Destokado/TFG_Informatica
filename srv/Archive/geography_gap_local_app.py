...
def params_to_df(langs, content_type, geographical_entity):
    ...
    if content_type == 'wikidata_article_qitems':
        ...
        query = "SELECT set1,set1descriptor,set2,set2descriptor, abs_value, rel_value FROM wcdo_intersections_accumulated WHERE set1descriptor = 'geolocated' AND content = 'articles' AND period = '"+cycle_year_month+"' AND set2 = '"+geographical_entity+"' AND set1 = 'wikidata_article_qitems' ORDER BY abs_value DESC;"
    ...
    if content_type == 'all_wp_all_articles':
        ...
        query = "SELECT set1,set1descriptor,set2,set2descriptor, abs_value, rel_value FROM wcdo_intersections_accumulated WHERE set1descriptor = 'geolocated' AND content = 'articles' AND period = '"+cycle_year_month+"' AND set1 = 'all_wp_all_articles' AND set2 = '"+geographical_entity+"' ORDER BY abs_value DESC;"
    ...
    if content_type == 'lang geographical entities':
        ...
        query = "SELECT set1,set1descriptor,set2,set2descriptor, abs_value, rel_value, period FROM wcdo_intersections_accumulated WHERE set1descriptor = 'geolocated' AND content = 'articles' AND set1 IN ("+lass+") AND set2 = '"+geographical_entity+"' AND period = '"+cycle_year_month+"' ORDER BY abs_value DESC;"
...
if __name__ == '__main__':
    dash_app3.run_server(debug=True)
