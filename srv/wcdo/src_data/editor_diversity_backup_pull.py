...
# - fer la base de dades d’editors amb la catalana.

# base de dades amb columnes per features d’editors?
# base de dades amb files per features d’editors? -> aquest. 

# hauria de revisar els arxius antics de les bases de dades per veure quant ocupava cadascuna.
